...
public class OrdHed {
    ...
    private ArrayList<OrdDet> soDetArrayList;

    public ArrayList<OrdDet> getSoDetArrayList() {
        return soDetArrayList;
    }

    public void setSoDetArrayList(ArrayList<OrdDet> soDetArrayList) {
    ...
    public void setFORDHED_UPLOAD_TIME(String fORDHED_UPLOAD_TIME) {
        FORDHED_UPLOAD_TIME = fORDHED_UPLOAD_TIME;
    }

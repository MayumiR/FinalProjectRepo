...
public class Debtor {
	...
	private String FDEBTOR_REP_CODE;
	...
	private String FDEBTOR_TAXREG;
	private String FDEBTOR_PRIL_CODE;
	private String FDEBTOR_ROUTE_CODE;
	private String FDEBTOR_CHK_MUSTFREE;
	...
	public String getFDEBTOR_REP_CODE() {
		return FDEBTOR_REP_CODE;
	}
	public void setFDEBTOR_REP_CODE(String fDEBTOR_REP_CODE) {
		FDEBTOR_REP_CODE = fDEBTOR_REP_CODE;
	}
	...
	public String getFDEBTOR_TAXREG() {
		return FDEBTOR_TAXREG;
	}
	public void setFDEBTOR_TAXREG(String fDEBTOR_TAXREG) {
		FDEBTOR_TAXREG = fDEBTOR_TAXREG;
	}
	public String getFDEBTOR_PRIL_CODE() {
		return FDEBTOR_PRIL_CODE;
	}
	public void setFDEBTOR_PRIL_CODE(String fDEBTOR_PRIL_CODE) {
		FDEBTOR_PRIL_CODE = fDEBTOR_PRIL_CODE;
	}
	public String getFDEBTOR_ROUTE_CODE() {
		return FDEBTOR_ROUTE_CODE;
	}
	public void setFDEBTOR_ROUTE_CODE(String fDEBTOR_ROUTE_CODE) {
		FDEBTOR_ROUTE_CODE = fDEBTOR_ROUTE_CODE;
	}
	public String getFDEBTOR_CHK_MUSTFREE() {
		return FDEBTOR_CHK_MUSTFREE;
	}
	public void setFDEBTOR_CHK_MUSTFREE(String fDEBTOR_CHK_MUSTFREE) {
		FDEBTOR_CHK_MUSTFREE = fDEBTOR_CHK_MUSTFREE;
	}
	public String getFDEBTOR_CHK_FREE() {
		return FDEBTOR_CHK_FREE;
	}
	public void setFDEBTOR_CHK_FREE(String fDEBTOR_CHK_FREE) {
		FDEBTOR_CHK_FREE = fDEBTOR_CHK_FREE;
	}
